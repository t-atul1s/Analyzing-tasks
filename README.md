...
Analysis artifacts for exercises **B1**, **B2**, **B3**, **I1**, **I2**, and **I3** from the coding-agent assessment.  
...
| This repo | B1, B2, B3, I1, I2, I3 — OSS repo analysis + I3 writeup |
...
| I2 | End-to-end flow trace | [i2-flow-trace.md](./i2-flow-trace.md) | POST user item creation → DB |
